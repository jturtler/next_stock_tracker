    ...
    return (
        <nav className="bg-[#edf2f7] text-[#2d3748] p-4">
          <ul className="flex space-x-4">
            ...
            {user !== null &&<li> <a href="#" className={` ${selected == Constant.UI_PAGE_PORTFOLIO ? "bg-[#e2e8f0]" : ""} hover:bg-[#e2e8f0] p-2 rounded font-medium text-sm`} onClick={() => handleOnClick(Constant.UI_PAGE_PORTFOLIO)}>Portfolio</a></li>}
