			...
			{isOpen && (
				<div ref={divRef} className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg">
					<ul className="py-1">
						...
						<li className="px-4 py-2 text-gray-700 hover:bg-gray-100 flex space-x-2 items-center border-b border-gray-200" onClick={() => handleItemClick("logout")} >
							<a href="#" className="block px-4 py-2 text-gray-700 hover:bg-gray-100" onClick={() => handleItemClick("logout")} >
							<IoLogOutSharp />
							<span>Log-out</span>
							</a>
						</li>
